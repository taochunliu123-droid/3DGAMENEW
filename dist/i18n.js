...
export const DICT={
  ...
  tipReward:[p=>`過關獎勵：${p}（最多錯 1 題才能帶走）`,p=>`Reward: ${p} (at most 1 wrong to win it)`],
  ...
  endWin:[(e,p)=>`${e}被打倒了！錯 1 題以內的隊伍帶走了${p}。`,(e,p)=>`${e} is down! Teams with 1 or fewer wrong won the ${p}.`],
  endLose:[e=>`這次${e}比較強。最多只能錯 1 題才能過關，再來一次！`,e=>`${e} was too strong this time. You can miss only 1 to clear it. Try again!`],
  scoreLine:[(c,n)=>`答對 ${c} / ${n}`,(c,n)=>`${c} / ${n} correct`],mvp:['本關最佳','Stage MVP'],
  moreToWin:[w=>`錯 ${w} 題，錯 1 題以內才能帶走夥伴`,w=>`${w} wrong. Need 1 or fewer to win the buddy`],
  nextStage:[s=>s===7?'挑戰魔王關':`前往第 ${s} 關`,s=>s===7?'On to the Boss':`On to Stage ${s}`],
  victory:['勝利！','VICTORY!'],defeated:[e=>`擊敗 ${e}`,e=>`${e} defeated`],
  lost:['再接再厲','TRY AGAIN'],enemyWins:[e=>`${e} 還站著……`,e=>`${e} is still standing…`],
